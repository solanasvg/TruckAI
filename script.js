...
function app() {
	...
	var adjustWindow = () => {
		...
		init = () => {
			// setup
			let licensePlate = textureLoader.load("https://assets.codepen.io/416221/license-plate.png"),
				grassTile = textureLoader.load("https://assets.codepen.io/416221/grass.jpg"),
				roadTile = textureLoader.load("https://assets.codepen.io/416221/road.jpg");
